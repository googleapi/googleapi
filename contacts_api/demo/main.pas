...
begin
  case Contact.Contacts[ListBox1.ItemIndex].Relations[ComboBox5.ItemIndex].Realition of
   trNone:label13.Caption:='Неизвестно';
   trAssistant:label13.Caption:='Помощник';
   trBrother:label13.Caption:='Брат';
   trChild:label13.Caption:='Ребенок';
   trDomesticPartner:label13.Caption:='';
   trFather:label13.Caption:='Партнер';
   trFriend:label13.Caption:='Друг';
   trManager:label13.Caption:='Начальник';
   trMother:label13.Caption:='Мать';
   trParent:label13.Caption:='Родитель';
   trPartner:label13.Caption:='Партнер';
   trReferredBy:label13.Caption:='Приглашенный';
   trRelative:label13.Caption:='Участник';
   trSister:label13.Caption:='Сестра';
   trSpouse:label13.Caption:='Супруга';
  end;
end;
