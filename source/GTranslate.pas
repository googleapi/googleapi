{ =============================================================================|
  ...
  |unit: GTranslate                                                            |
  |============================================================================|
  |Описание: Модуль для работы с переводчиком Google.                          |
  |============================================================================|
  |Зависимости:                                                                |
  ...
  |v. 0.2                                                                      |
  | + поддержка API v.2                                                        |
  | + свойство key: string - ключ доступа к API                                |
  |============================================================================ }
unit GTranslate;
...
resourcestring
  ...
  rsErrorTrnsl = 'Во время перевода произошла ошибка';
  rsErrLagrgeReq =
    'Количество символов в тексте для перевода превышает допустимое значение в 5000';
