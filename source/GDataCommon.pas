...
type
  {Класс общего назначения, определющий любой XML-узел, который
   ...
   Свойства класса будут иметь следующие значения:
     Name = node
     Value = "Text of Node"
  ...
  public
    {Конструктор для создания "пустого" экземпляра, т.е. не содержащего
     каких-либо значений, либо для создания экземпляра по данным XML-узла документа}
